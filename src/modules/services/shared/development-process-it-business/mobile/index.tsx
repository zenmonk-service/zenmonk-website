  ...
  const steps = [
    {
      ...
      description: 'Analyzing current technology stacks, organizational bottlenecks, and business goals.',
      color: '#00B0BC',
      icon: MobileIcon1,
    },
    {
      ...
      description: 'Crafting tailored IT modernization roadmaps, tech stacks, and digital strategies.',
      color: '#0062AE',
      icon: MobileIcon2,
    },
    {
      number: 3,
      title: 'Development',
      description: 'Guiding seamless execution, architectural modernization, and change management.',
      color: '#8645DC',
      icon: MobileIcon3,
    },
    {
      ...
      description: 'Refining operational workflows, security posture, and IT infrastructure efficiency.',
      color: '#0EA62A',
      icon: MobileIcon4,
    },
    {
      ...
      description: 'Delivering long-term strategic oversight, tech governance, and scalable ROI.',
      color: '#FF764C',
      icon: MobileIcon5,
    },
  ]
